...
export default function Settings() {
  ...
  return (
    <View style={[styles.container, { backgroundColor: colors.background }]}>
      ...
      <TouchableOpacity style={[styles.button, { backgroundColor: colors.error }]} onPress={() => router.push('/goodbye')}>
        <Text style={[styles.buttonText, { color: colors.onPrimary }]}>Logout</Text>
      </TouchableOpacity>
    </View>
  );
}
